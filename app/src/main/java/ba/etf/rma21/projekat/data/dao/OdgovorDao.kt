...
interface OdgovorDao {
    @Query("INSERT INTO Odgovor VALUES(:id, :odgovoreno, :PitanjeId, :KvizId, :KvizTakenId)")
    fun dodajOdgovor(id : Int, odgovoreno : Int, PitanjeId : Int, KvizId: Int, KvizTakenId: Int)
